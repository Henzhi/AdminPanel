<template>
  <div class="log-page">
    ...
    <!-- 详情对话框 -->
    <el-dialog v-model="detailVisible" title="安全日志详情" width="720px">
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="时间" :span="2">{{ formatDateTime(detailData.createTime) }}</el-descriptions-item>
...
import { getSecurityLogs, getLogDetail, deleteLog, exportLogs } from '@/api/log'
...
async function loadData() {
  loading.value = true
  try {
    const res = await getSecurityLogs(queryParams)
