  ...
  <div class="log-page">
    ...
    <el-card class="search-card" shadow="never">
      <el-form :model="queryParams" inline class="search-form">
        <el-form-item label="操作类型">
          <el-select v-model="queryParams.operationType" placeholder="全部" clearable style="width: 160px">
            <el-option label="系统启动" value="SYSTEM_START" />
            <el-option label="定时任务" value="SCHEDULED_TASK" />
            <el-option label="备份任务" value="BACKUP" />
            <el-option label="恢复任务" value="RESTORE" />
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="tableData" stripe border style="width: 100%">
        ...
        <el-table-column prop="operationType" label="类型" width="140" align="center">
        ...
        <el-table-column prop="operationTarget" label="操作目标" min-width="180" show-overflow-tooltip />
    ...
    <!-- 详情对话框 -->
    <el-dialog v-model="detailVisible" title="系统日志详情" width="720px">
...
import { getSystemLogs, getLogDetail, deleteLog, exportLogs } from '@/api/log'
